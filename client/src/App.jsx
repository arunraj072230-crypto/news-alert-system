  ...
  const fetchNewsForCategories = async (categories) => {
    try {
      const requests = categories.map((category) =>
        axios.get(
          `https://news-alert-system-bgbm.onrender.com/api/news?category=${category}`
        )
      );
  ...
  const loadNotifications = async () => {
    try {
      const response = await axios.get(
        "https://news-alert-system-bgbm.onrender.com/api/notifications"
      );
...
useEffect(() => {
  ...
  const searchNews = async () => {
    try {
      const response = await axios.get(
        `https://news-alert-system-bgbm.onrender.com/api/news?category=${search}`
      );
  ...
  useEffect(() => {
    const loadPreferences = async () => {
      try {
        const response = await axios.get(
          "https://news-alert-system-bgbm.onrender.com/api/preferences"
        );
